...
public class ImageServletTimo extends HttpServlet {
    ...
    protected AppModuleAMImpl findULDLAppModule() {
        BindingContext bindingContext = BindingContext.getCurrent();
        DCBindingContainer amx = bindingContext.findBindingContainer("empAttachment_dummyPageDef");
        AppModuleAMImpl am = (AppModuleAMImpl) amx.getDataControl().getApplicationModule();
        return am;
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            System.out.println("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX              XXXXXXXXXXXXXXXXXXXXXXXXX   TIMO IMAGE SERVLET");
            ...
            if (tmporaryFilePath.isEmpty()) {
                ...
                empAttachVORow imageRow = (empAttachVORow) obj;
